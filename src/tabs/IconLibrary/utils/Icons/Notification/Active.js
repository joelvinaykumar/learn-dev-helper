...
export const NotificationActiveSVG = props => (
  <React.Fragment>
    <svg height={props.height} width={props.width} viewBox="0 0 23 25" {...props}>
      <desc>Created with Sketch.</desc>
      <g id="Symbols" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
        <g id="Header-Main" transform="translate(-1247.000000, -3.000000)" fillRule="nonzero">
          <g id="Group-7">
            <g id="Group-2">
              <g id="Group-12" transform="translate(1248.000000, 4.000000)">
                <g id="Notification-Icon" stroke="#000000" strokeLinecap="round" strokeWidth="1.5">
                ...
                <circle id="Oval-4" stroke="#FFFFFF" strokeWidth={3} fill="#FF3366" cx={16} cy={5} r="4.5" />
              </g>
            </g>
          </g>
        </g>
...
NotificationActiveSVG.defaultProps = {
  width: 23,
  height: 25,
};

NotificationActiveSVG.propTypes = {
